...
Nova.booting(function (Vue, router, store) {
  Vue.component('dependency-filter', __webpack_require__(3));
});
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_vue_slider_component__ = __webpack_require__(6);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_vue_slider_component_theme_default_css__ = __webpack_require__(12);
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    handleRangeChange: function handleRangeChange(event) {
  ...
  computed: {
    ...
    minOption: function minOption() {
      return this.initialOptions[0].value;
    },
    maxOption: function maxOption() {
  ...
  watch: {
    selected: function selected() {
      this.$store.commit(this.resourceName + '/updateFilterState', {
        filterClass: this.filterKey,
        value: this.selected.map(function (e) {
          return e.value;
        })
      });
      this.$emit('change');
...
var render = function() {
  ...
  return _c("div", { class: _vm.filter.width }, [
    !_vm.filter.notification
      ? _c(
          "h3",
    ...
    _c(
      ...
      { staticClass: "p-2" },
      [
        _vm.filter.multiple === false && _vm.filter.range === false
          ? _c(
              "select",
              {
          ...
          : _vm._e(),
        _vm._v(" "),
        _vm.filter.multiple === true
          ? _c(
              "div",
              {
                staticClass:
                  "flex h-auto block w-full form-control-sm form-select",
                attrs: { tabindex: "-1" }
              },
              [
                _vm.selected.length === 0
                  ? _c("div", { staticClass: "h-8 pt-1 leading-normal" }, [
                      _vm._v("—")
                    ])
                  : _c(
                      "ul",
                      {
                        ref: "selected",
                        staticClass:
                          "list-reset flex flex-wrap text-sm -ml-2 pb-1"
                      },
                      _vm._l(_vm.selected, function(option, index) {
                        return _c(
                          ...
                          {
                            staticClass:
                              "bg-primary text-white rounded -ml-0 mt-1 mr-1 px-2 py-1 hover:bg-primary-dark",
                            class: option.value,
                            on: {
                ...
                _vm._v(" "),
                _vm.showDropdown && _vm.availableOptions.length
                  ? _c(
                      "ul",
                      {
                        staticClass:
                          "list-reset absolute top-auto w-1/2 -ml-6 py-1 border border-60 rounded-lg bg-30 z-50"
                      },
                      _vm._l(_vm.availableOptions, function(option) {
                        return _c(
                          ...
                          {
                            staticClass:
                              "truncate max-w-full px-3 py-1 hover:text-white hover:bg-primary-dark",
                            on: {
                              click: function($event) {
        ...
        _vm.filter.range === true
          ...
          : _vm._e(),
        _vm._v(" "),
        _vm.filter.notification && this.hasUpdates
          ? _c("div", [
              _c(
                "button",
                {
                  staticClass: "btn btn-default btn-primary mb-2 to-right",
                  on: { click: _vm.showUpdates }
                },
                [
                  _vm._v(
                    "\n                " +
                      _vm._s(_vm.__("Show updated cars since last login")) +
                      "\n            "
                  )
                ]
              )
