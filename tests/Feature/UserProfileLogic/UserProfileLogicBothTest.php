...
class UserProfileLogicBothTest extends TestCase
{
    /**
     * @var User
     */
     ...
     * * @test
     */
    public function BothImportSuccessTest()
    {
        $user = User::factory(['stock_type' => 'both', 'import_types' => 'IR', 'vehicle_type' => ['Passenger', 'LCV']])
            ->has(Company::factory())
            ->create();
        ...
        $filePath = storage_path("test-lists") . "/unified_list_valid_both.xlsx";

        $file = new \Symfony\Component\HttpFoundation\File\UploadedFile ($filePath, 'unified_list_valid_both.xlsx', null, null, true);
    ...
    {
        $user = User::factory(['stock_type' => 'both', 'import_types' => 'IR', 'vehicle_type' => ['Passenger']])
            ->has(Company::factory())
            ->create();
     ...
     * * @test
     */
    public function BothImportUserOverWriteOtherUserSuccess()
    {
        $user = User::factory(['stock_type' => 'both', 'import_types' => 'IR', 'company_id' => $this->ncCompany->id, 'country' => strtoupper($this->ncCountry), 'vehicle_type' => ['LCV', 'Passenger']])
                ->create();
     ...
     * * @test
     */
    public function BothImportCombinationSuccess()
    {
        //Additional user

        User::factory(['stock_type' => 'UC', 'company_id' => $this->ncCompany->id, 'country' => strtoupper($this->ncCountry), 'vehicle_type' => ['LCV']])
            ->has(Company::factory())
            ->create();

        $ucCompany = $this->ncCompany;
        $ucCountry = $this->ncCountry;
        ...
        User::factory(['stock_type' => 'NC', 'import_types' => 'IR', 'company_id' => $this->ncCompany->id, 'country' => strtoupper($this->ncCountry), 'vehicle_type' => ['Truck']])
            ->create();
        ...
        $user = User::factory(['stock_type' => 'both', 'import_types' => 'IR', 'company_id' => $this->ncCompany->id, 'country' => strtoupper($this->ncCountry), 'vehicle_type' => ['Passenger', 'Truck', 'LCV']])
            ->create();
