...
class StockOpel extends Resource
{
     ...
     * @var string
     */
    public static $model = \App\StockOpel::class;
    ...
    public function cards(Request $request)
    {
        ...
        $updates = $notificationService->getNotificationUpdates(StockOpelImport::class);
        ...
        return [
            (new UsedCarsFiltering())->withMeta([
                ...
                'listType' => StockOpelImport::class,
            ])
        ];
    }
    ...
    {
        return [
            (new CountrySelect('country', \App\StockOpel::class))->withMeta([
                'name' => 'Country',
                'type' => 'string',
                'multiple' => false,
                'range' => false,
            ...
            (new OptionsSelect('family', \App\StockOpel::class))->withMeta([
                'name' => 'Family',
                'type' => 'string',
                'multiple' => false,
                'range' => false,
            ...
            (new OptionsSelect('model_name', \App\StockOpel::class))->withMeta([
                'name' => 'Model name',
                'type' => 'string',
                'multiple' => false,
                'range' => false,
            ...
            (new OptionsSelect('color', \App\StockOpel::class))->withMeta([
                'name' => 'Color',
                'type' => 'string',
                'multiple' => false,
                'range' => false,
            ...
            (new OptionsSelect('vpvu', \App\StockOpel::class))->withMeta([
                'name' => 'Passenger/LCV',
                'type' => 'string',
                'multiple' => false,
                'range' => false,
            ...
            (new NotificationUpdateFilter('vin', \App\StockOpel::class))->withMeta([
                'name' => 'Updated vin',
                'type' => 'string',
                'multiple' => 'NAN',
                'notification' => true,
    ...
    {
        return [
            (new DataExport('stock-opels.xlsx', 'opel', new \App\StockOpel()))->canSee(function ($request) {
                return true;
