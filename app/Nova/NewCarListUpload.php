...
class NewCarListUpload extends Resource
{
    /**
     ...
     * @var string
     */
    public static $model = \App\NewCarListUpload::class;
    ...
    public function fields(Request $request)
    {
        return [
            ...
            Text::make('Status')->nullable()->readonly()->asHtml()->exceptOnForms(),
