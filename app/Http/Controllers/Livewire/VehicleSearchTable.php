...
class VehicleSearchTable extends Component
{
...
//            }
    ...
    {
        session()->put('templateName', 'frontend.livewire.vehicle-search2');
        return view('frontend.livewire.vehicle-search-table')->layout('frontend.layouts.app');
    }
