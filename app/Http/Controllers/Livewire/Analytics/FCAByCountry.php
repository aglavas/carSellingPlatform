...
class FCAByCountry extends Component
{
    ...
    public function render()
    {
        ...
        return view('frontend.livewire.analytics.f-c-a-by-country');
    }
    ...
    {
        $stockFCA = new StockFCA();

        $query = $stockFCA->select('country', DB::raw('count(*) as total'));
