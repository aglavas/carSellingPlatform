...
class NewCarsPerCountryOverTime extends Component
{
    ...
    public function render()
    {
        ...
        return view('frontend.livewire.analytics.new-cars-per-country-over-time');
    }
    ...
    protected function setValues()
    {
        ...
        foreach ($carsOverTimeCollection as $item) {
            ...
            $newCarsPerCountryArray = $stats['CountOfNewCarsPerCountry'];

            if (count($newCarsPerCountryArray) == 0) {
            ...
            $countries = array_keys($newCarsPerCountryArray);
            ...
            foreach ($newCarsPerCountryArray as $country => $data) {
                $iterations = 0;
