...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <div class="mt-4 flex h-16 items-center justify-between text-base font-normal text-gray-900">
        <div x-data="{id: 5}" @click="$dispatch('open-dropdown',{id})"  class="flex mr-8 clickable">
        ...
        <div class="relative flex items-stretch flex-grow focus-within:z-10">
            ...
            <input wire:model.debounce.800ms="search" type="text" name="search" id="search" class="block w-full rounded pl-10 sm:text-sm border-gray-300 placeholder-gray-300" placeholder="Search by make, model or keyword" data-np-checked="1">
        </div>
    </div>
</div>
<div class="bg-white">
    ...
    <div class="max-w-3xl mx-auto px-4 text-center sm:px-6 lg:max-w-7xl lg:px-8">
        <section aria-labelledby="filter-heading" class="border-gray-200 py-6">
            <div class="flex items-center justify-between">
                <div x-data="{ sort: false }" @click.away="sort = false" class="relative z-10 inline-block text-left">
                    <div>
                    ...
                    <div x-transition:enter="transition ease-out duration-100"
                        ...
                        <livewire:sort-bulk-action :sortField="$sortField" :sortDirection="$sortDirection" :transaction="true"/>
                    </div>
                </div>
                ...
                <div class="hidden sm:flex sm:items-baseline sm:space-x-8">
                    ...
                    <div x-data="{ bulk: false }" @click.away="bulk = false" id="desktop-menu-1" class="relative z-10 inline-block text-left">
                        ...
                        <div x-transition:enter="transition ease-out duration-100"
                            ...
                            <div class="flex items-center">
                                <div wire:click="exportSelected(false)" class="block px-4 py-2 text-sm font-medium text-gray-900 clickable" role="menuitem" tabindex="-1" id="mobile-menu-item-0">
                                    Export all as Excel
                                </div>
                            </div>
                            <div class="flex items-center">
                                <div wire:click="exportSelected(true)" class="block px-4 py-2 text-sm font-medium text-gray-900 clickable" role="menuitem" tabindex="-1" id="mobile-menu-item-0">
                                    Export filtered as Excel
                                </div>
                            </div>
                            @if (($type === 'seller') && ($listType === 'enquiry'))
                                <div class="flex items-center">
                                    <div wire:click="approveSelected" class="block px-4 py-2 text-sm font-medium text-gray-900 clickable" role="menuitem" tabindex="-1" id="mobile-menu-item-0">
                                        Approved selected transactions
                                    </div>
                                </div>
                                <div class="flex items-center">
                                    <div wire:click="declineSelected" class="block px-4 py-2 text-sm font-medium text-gray-900 clickable" role="menuitem" tabindex="-1" id="mobile-menu-item-0">
