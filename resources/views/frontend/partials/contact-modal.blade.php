<div
    class="border-t border-gray-200 mt-10 pt-10 z-50"
    x-data="{ open: false }"
    x-show="open"
    @open-dropdown.window="if ($event.detail.id == 99) open = true"
    ...
    <div class="fixed inset-0 overflow-y-auto" aria-labelledby="modal-title" role="dialog" aria-modal="true">
        <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
            ...
            <div x-transition:enter="ease-out duration-300"
                ...
                <div class="mt-3 z-50">
                    <h3 class="text-lg leading-6 font-medium text-gray-900" id="modal-headline">Contact - {{ $vehicle->company }}</h3>
                    <div class="mt-2">

                        <table class="min-w-full divide-y divide-gray-200 z-50">
                            <tbody class="bg-white divide-y divide-gray-200 z-50">
                            @foreach($users as $user)
                                <tr>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900 z-50">
                                        {{ $user->name }}
                                        <br>
                                        <dt class="mt-1">
