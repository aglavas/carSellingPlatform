{{--<div class="h-full divide-y divide-gray-200 flex flex-col bg-white shadow-xl">--}}
    {{--<div class="min-h-0 flex-1 flex flex-col overflow-y-scroll">--}}
        ...
        {{--<div class="mt-6 relative flex-1 px-4 sm:px-6">--}}
            {{--<x-data-list>--}}
                {{--<x-data-list-item label="Family" value="{{ $vehicle->family }}"/>--}}
                ...
                {{--<x-data-list-item label="Caf" value="{{ $vehicle->caf }}"/>--}}
                {{--<x-data-list-item label="Order Number" value="{{ $vehicle->order_number }}"/>--}}
                {{--<x-data-list-item label="Vin" value="{{ $vehicle->vin }}"/>--}}
                {{--<x-data-list-item label="Options" value="{{ $vehicle->options }}"/>--}}
                {{--<x-data-list-item label="Transaction Date" value="{{ $vehicle->transaction_date }}"/>--}}
