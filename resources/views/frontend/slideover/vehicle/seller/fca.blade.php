    ...
    {{--<div class="min-h-0 flex-1 flex flex-col overflow-y-scroll">--}}
        ...
        {{--<div class="mt-6 relative flex-1 px-4 sm:px-6">--}}
            {{--<x-data-list>--}}
                ...
                {{--<x-data-list-item label="Model" value="{{ $vehicle->model_name }}"/>--}}
                {{--<x-data-list-item label="Version" value="{{ $vehicle->version }}"/>--}}
                {{--<x-data-list-item label="Model Id" value="{{ $vehicle->model_id }}"/>--}}
                {{--<x-data-list-item label="Equipment" value="{{ $vehicle->equipment }}"/>--}}
                {{--<x-data-list-item label="Equipment Description" value="{{ $vehicle->equipment_description }}"/>--}}
                {{--<x-data-list-item label="Options" value="{{ $vehicle->options }}"/>--}}
                {{--<x-data-list-item label="Options Description" value="{{ $vehicle->options_description }}"/>--}}
                ...
                {{--<x-data-list-item label="Ident" value="{{ $vehicle->ident }}"/>--}}
            {{--</x-data-list>--}}
        {{--</div>--}}
        {{--<div class="mt-6 relative flex-1 px-4 sm:px-6">--}}
