<div>
    @if ($show)
        <div class="z-20 fixed inset-0 overflow-y-auto" aria-labelledby="modal-title" role="dialog" aria-modal="true" x-data>
            <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
                ...
                <div @click.away="$wire.closeModal()"
                    ...
                    <div class="mt-3">
                        <h3 class="text-lg leading-6 font-medium text-gray-900" id="modal-headline">Contact - {{ $company }}</h3>
                        <div class="mt-2">
