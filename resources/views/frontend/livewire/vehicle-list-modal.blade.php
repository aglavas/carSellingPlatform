        ...
        <div class="fixed inset-0 overflow-y-auto" aria-labelledby="modal-title" role="dialog" aria-modal="true">
            <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
                ...
                <div x-transition:enter="ease-out duration-300"
                     ...
                     class="inline-block align-bottom bg-white rounded-lg px-4 pt-5 pb-4 text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-max sm:w-full sm:p-6 z-90">
                    ...
                    <div class="mt-2">
                        <h3 class="text-lg leading-6 font-medium text-gray-900" id="modal-headline">Vehicles in your enquiry</h3>
                        <div class="mt-5">
